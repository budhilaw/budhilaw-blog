        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
            <div class="mb-4 md:mb-0">
                <ul class='flex gap-x-4 z-50'>
                    <li>
                        <a href="https://facebook.com/ebudhilaw" class="text-gray-500 hover:text-[#1877F2] dark:text-gray-300 dark:hover:text-[#1877F2]">
                    ...
                    <li>
                        <a href="https://x.com/ceritaeric" class="text-gray-500 hover:text-[#1DA1F2] dark:text-gray-300 dark:hover:text-[#1DA1F2]">
                    ...
                    <li>
                        <a href="https://instagram.com/ceritaeric" class="text-gray-500 hover:text-[#E4405F] dark:text-gray-300 dark:hover:text-[#E4405F]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" color="currentColor"><path d="M2.5 12c0-4.478 0-6.718 1.391-8.109S7.521 2.5 12 2.5c4.478 0 6.718 0 8.109 1.391S21.5 7.521 21.5 12c0 4.478 0 6.718-1.391 8.109S16.479 21.5 12 21.5c-4.478 0-6.718 0-8.109-1.391S2.5 16.479 2.5 12"/><path d="M16.5 12a4.5 4.5 0 1 1-9 0a4.5 4.5 0 0 1 9 0m1.008-5.5h-.01"/></g>
                            </svg>
                        </a>
                    </li>
                    <li>
                        <a href="https://bsky.app/profile/budhilaw.bsky.social" class="text-gray-500 hover:text-[#0085FF] dark:text-gray-300 dark:hover:text-[#0085FF]">
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/budhilaw/" class="text-gray-500 hover:text-[#0A66C2] dark:text-gray-300 dark:hover:text-[#0A66C2]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
                    ...
                    <li>
                        <a href="https://github.com/budhilaw" class="text-gray-500 hover:text-[#181717] dark:text-gray-300 dark:hover:text-[#181717]">
                            <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">

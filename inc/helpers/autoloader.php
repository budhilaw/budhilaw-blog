...
namespace BUDHILAW_THEME\Inc\Helpers;
...
function autoloader( string $resource = '' ): void {
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( BUDHILAW_DIR_PATH ), $directory, $file_name );
...
spl_autoload_register( '\BUDHILAW_THEME\Inc\Helpers\autoloader' );